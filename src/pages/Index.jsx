    ...
    <div className="flex items-center justify-between">
      ...
      <div className="flex items-center space-x-2">
        ...
        <div className="flex items-center space-x-2 ml-4">
          ...
          <div className="w-24 bg-gray-200 rounded-full h-1 relative">
            <div className="bg-blue-500 h-1 rounded-full w-2/3"></div>
            <div className="absolute top-1/2 right-1/3 w-3 h-3 bg-blue-500 rounded-full transform -translate-y-1/2"></div>
          </div>
        </div>
